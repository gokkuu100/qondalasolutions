...
export async function generateChatResponse(message: string, conversationHistory: Array<{role: 'user' | 'assistant', content: string}>): Promise<string> {
  try {
    const systemPrompt = `You are Zinex Technology Assistant, a helpful AI assistant for Zinex Technology - a technology company that offers comprehensive enterprise solutions combining software, hardware, and AI-driven automation.
...
Your role:
- Help visitors understand Zinex Technology's services and solutions
