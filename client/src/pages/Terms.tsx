    ...
    <div className="min-h-screen bg-gray-50 py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-sm p-8">
          <h1 className="text-4xl font-bold text-ms-dark mb-8">Terms of Service</h1>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-semibold text-ms-dark mt-8 mb-4">Use License</h2>
            <p className="text-gray-600 mb-4">
              Permission is granted to temporarily access our services for personal or commercial use. 
              This is the grant of a license, not a transfer of title.
            </p>
            
            <h2 className="text-2xl font-semibold text-ms-dark mt-8 mb-4">Service Availability</h2>
            <p className="text-gray-600 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-ms-dark mt-8 mb-4">User Responsibilities</h2>
            <p className="text-gray-600 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-ms-dark mt-8 mb-4">Contact Information</h2>
            <p className="text-gray-600 mb-4">
